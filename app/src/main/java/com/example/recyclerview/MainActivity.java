...
public class  MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //get method for json request
        queue = Volley.newRequestQueue(this);
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, " https://raw.githubusercontent.com/kenobicjj/android/main/tutorial4.json ", null, new Response.Listener<JSONArray>() {
                    @Override
    ...
    class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
        ...
        public void onBindViewHolder(@NonNull MyViewHolder holder, int i) {
            ...
            String iconUrl = "https://raw.githubusercontent.com/kenobicjj/android/main/"+elements.get(i).getIcon();
